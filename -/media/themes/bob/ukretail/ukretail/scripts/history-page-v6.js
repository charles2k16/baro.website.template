...
$xa('.history-key-milestone-details-slider').slick({
    slidesToShow: 1,
    slidesToScroll: 1,
    arrows: true,
    fade: true,
    infinite: false,
    adaptiveHeight: true,
    asNavFor: '.history-key-milestone-year-slider',
  ...
  $xa('.history-key-milestone-year-slider').slick({
    slidesToShow: 10,
    slidesToScroll: 1,
    asNavFor: '.history-key-milestone-details-slider',
    dots: false,
    infinite: false,
    focusOnSelect: true,
    centerMode: true,
